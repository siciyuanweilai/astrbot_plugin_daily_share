...
export const TARGET_IDS = Object.freeze({
  global: "global",
  qzone: "qzone_broadcast",
  briefing: "briefing",
  briefingBroadcast: "briefing_broadcast",
});
export const BUILTIN_TARGET_IDS = new Set(Object.values(TARGET_IDS));
...
export function triggerSummary(modeValue) {
  return triggerModeLabel(text(modeValue) || "fixed_time");
}
...
export function targetLabel(value, label = "", kind = "") {
  ...
  if (!raw) return "全局";
  const knownLabels = {
    [TARGET_IDS.qzone]: "QQ 空间",
    [TARGET_IDS.global]: "全局分享",
    [TARGET_IDS.briefing]: "早报",
    [TARGET_IDS.briefingBroadcast]: "早报",
  };
