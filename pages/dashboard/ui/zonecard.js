...
export function createQzonePostCardRenderer({ state, handleDeletePost }) {
  return function createPostCard(item = {}) {
    ...
    main.className = "qzone-card-main";
    const selectButton = document.createElement("button");
    selectButton.type = "button";
    selectButton.className = "qzone-card-select";
    selectButton.dataset.qzoneAction = "select";
    selectButton.dataset.postId = id;
    selectButton.setAttribute("aria-label", `查看 ${authorName(item)} 的说说详情`);
    ...
    selectButton.append(head, content);
    ...
    card.append(main, createCardSocial(item, id, state));
    return card;
  };
}
