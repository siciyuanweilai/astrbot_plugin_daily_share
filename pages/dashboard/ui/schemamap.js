...
export const settingsFieldSchema = {
  ...
  cfgDailyLifeTextImageModel: { section: "image_conf", field: "daily_life_text_image_model" },
  cfgDailyLifeEditImageModel: { section: "image_conf", field: "daily_life_edit_image_model" },
...
export const settingsPayloadGroups = {
  ...
  media: [
    "cfgAiImage",
    "cfgDailyLifeTextImageModel",
    "cfgDailyLifeEditImageModel",
    "cfgHotImage",
