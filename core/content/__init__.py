...
from ..identity import build_self_identity_prompt
...
class ContentService(ContentSupportMixin, ContentGeneratorMixin):
    ...
    async def generate(self, stype: ShareType, period: TimePeriod, 
        ...
        ctx_data = {
            ...
            "self_identity_hint": build_self_identity_prompt(persona_info.get("prompt", "")),
