...
class QzoneAutoInteractionConfig:
    ...
    def from_conf(cls, conf: dict | None) -> "QzoneAutoInteractionConfig":
        ...
        return cls(
            ...
            comment_limit=_int_between(
                source.get(
                    "qzone_auto_comment_limit", QZONE_AUTO_COMMENT_DEFAULT_LIMIT
                ),
                QZONE_AUTO_COMMENT_DEFAULT_LIMIT,
                min_value=1,
                max_value=10,
            ...
            active_window_hours=_int_between(
                source.get("qzone_auto_interaction_active_hours", 24),
                24,
                min_value=0,
                max_value=168,
            ),
            ...
            comment_image_vision_provider=str(
                source.get("qzone_auto_comment_image_vision_provider", "") or ""
            ).strip(),
        )
    ...
    def interaction_enabled(self) -> bool:
        return bool(
            self.enable_qzone and self.enable_interaction and self.child_enabled
        )
