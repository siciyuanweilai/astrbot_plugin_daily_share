...
class QzoneH5NativeService(QzoneMethodSet):
    @staticmethod
    ...
    @staticmethod
    async def _send_h5_native_h2_request(
        writer: Any, conn: Any, header_items: list[tuple[str, str]], body: bytes
    ) -> None:
    ...
    def _handle_h5_native_h2_event(
        ...
        if isinstance(event, h2.events.ResponseReceived):
            ...
            text = self._decode_h5_body(raw, response.get("encoding") or "").decode(
                "utf-8", "ignore"
            )
    ...
    async def _h5_post_json_native_h2(
        ...
        *,
        ...
        try:
            ...
            header_items = self._h5_native_h2_header_items(
                ctx, parsed_url, path, headers
            )
