    ...
    async def _handle_manual_briefing_command(
        ...
        *,
        ...
        if arg == "60s":
            ...
            def task_factory():
                return self.static_outbox._run_static_news_image_share(
                    event,
                    url=url,
            ...
            def task_factory():
                return self.static_outbox._run_ai_news_image_share(
                    event,
                    is_broadcast=is_broadcast,
                    is_qzone_target=is_qzone_target,
                )
        ...
        target_desc = self.manual._manual_share_target_desc(
            is_broadcast=is_broadcast,
            is_qzone_target=is_qzone_target,
        )
